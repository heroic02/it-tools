...
<template>
  <c-tooltip :tooltip="$t('home.nav.github')" position="bottom">
    <c-button circle variant="text" href="https://github.com/heroic02" target="_blank" rel="noopener noreferrer"
  ...
  <c-tooltip :tooltip="$t('home.nav.twitter')" position="bottom">
    <c-button circle variant="text" href="https://twitter.com/hankdoo" rel="noopener" target="_blank"
